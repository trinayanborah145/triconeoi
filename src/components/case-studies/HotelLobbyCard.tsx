...
const HotelLobbyCard = () => {
  const navigate = useNavigate();
  
  const handleViewCaseStudy = (e: React.MouseEvent) => {
    e.stopPropagation();
    navigate('/case-studies/4');
  };

  return (
    <div 
      onClick={() => navigate('/case-studies/4')}
    ...
    >
      <div className="relative h-56 overflow-hidden">
        <img
          src="/placeholder.svg"
          alt="Project screenshot for Boutique Hotel Lobby"
      ...
      <div className="p-6">
        <h3 className="text-xl font-semibold mb-2">Boutique Hotel Lobby</h3>
        <p className="text-muted-foreground text-sm mb-4 line-clamp-2">
          Redesigned the entrance and lobby area of a boutique hotel to create a memorable first impression.
        </p>
        
        <div className="flex flex-wrap gap-2 mb-4">
          {["Lobby Design", "Lighting", "Furniture Selection"].map((service, i) => (
