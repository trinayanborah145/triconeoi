...
const RoomEditorsCard = () => {
  ...
  return (
    <div 
      onClick={() => navigate('/case-studies/2')}
    ...
    >
      <div className="relative h-56 overflow-hidden">
        <img
          src="/Screenshot 2025-08-24 150628.png"
          alt="Project screenshot for Room Editors"
      ...
      <div className="p-6">
        <h3 className="text-xl font-semibold mb-2">Room Editors</h3>
        <p className="text-muted-foreground text-sm mb-4 line-clamp-2">
          Room Editors an interior design business from Assam Guwahati.
        </p>
        
        <div className="flex flex-wrap gap-2 mb-4">
          {["Custom Coded Website", "SEO", "Modern & Sleek Design"].map((service, i) => (
...
export default RoomEditorsCard;
